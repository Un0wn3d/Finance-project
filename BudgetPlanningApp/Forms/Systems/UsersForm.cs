  ...
  public partial class UsersForm : Form {
    ...
    private void UsersGridView_CellClick(object sender, DataGridViewCellEventArgs e) {
      if (e.RowIndex >= 0 && UsersGridView[0, e.RowIndex].Value.ToString() != _UserList[0].Message) {
        ...
        UpdateUserForm updateUserForm = new UpdateUserForm(Convert.ToInt32(UsersGridView[0, e.RowIndex].Value.ToString()));
    ...
    private void LoadDataInKlientGridView(List<User> UserList) {
      ...
      if (UserList.Count > 0) {
        if (UserList[0].Message == NamesMy.NoDataNames.NoDataInUsers) {
          ...
          deviseIdColumn.DataPropertyName = "UserId";
